...
if ($_POST) {
  $statement = $pdo->prepare(
    "INSERT INTO court_date_request (reference_no, court_house_id, case_type, defendant_name, defendant_national_id, accused_name, accused_national_id, organisation_id) VALUES (:reference_no, :court_house_id, :case_type, :defendant_name, :defendant_id, :accused_name, :accused_id, :organisation_id)"
  );
  ...
  $statement->bindValue(":organisation_id", $_SESSION['user_id']);
  $statement->execute();
