  ...
  <div id="main-dashboard">
    <div class="container">
      <div class="header">
        <h1>Manage Admins</h1>
        <div>
          <a href="add_admin.php" class="primary">Add Admin</a>
        ...
        <tbody>
          <?php foreach ($admins as $i => $admin) : ?>
            <tr>
              ...
              <td class="actions">
                <a href="edit_admin.php?id=<?php echo $admin['id'] ?>" class="edit"><i class="fa-solid fa-user-pen"></i></a>
                <!-- <a href="delete_admin.php?id=<?php echo $admin['id'] ?>" class="delete"><i class="fa-solid fa-trash-can"></i></a> -->
